...
const Home = () => {
  ...
  return (
    <div className="my-6">
      <Banner></Banner>
      <div className="mt-28">
        <h2 className="text-center text-[#05386B] font-bold text-3xl  animate__animated animate__pulse animate__infinite mb-4">
          Estate Section
        </h2>
        ...
        <div
          id="estate-s"
          className="grid grid-cols-1 lg:grid-cols-3 gap-10 mt-10 mb-14"
        >
          {lands.map((land, idx) => (
